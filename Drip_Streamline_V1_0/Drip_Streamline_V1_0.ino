/* by Robert Werner (Official Streamline)
...
int endLED[9] = {
  ...
  startLED[8] + strandLength[8] }; //starting point of LED + strandLength
...
//  Serial.println();
 //--------------------------------------------------------------
  // local variables for the strand clock timers 
